        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <fieldset class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$productoid->nombre}}" id="rol" name="nombre">
                ...
                <fieldset class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$productoid->precio}}" id="Descripcion" name="precio">
