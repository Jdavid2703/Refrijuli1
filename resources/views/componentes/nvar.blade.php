<nav class="navbar navbar-expand-sm bg-info navbar-info fixed-top">
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            {{--<li class="nav-item ">--}}
                {{--<h4><a id="home1" class="nav-link {{request()->is('/')?'active':''}} " href="{{route('/')}}">Home <span--}}
                                {{--class="sr-only">(current)</span> </a></h4>--}}
            {{--</li>--}}

            <li class="nav-item">
                <h4><a id="informacion1" class="nav-link {{request()->is('nosotros')?'active':''}} "
                       href="{{route('informacion')}}">Información</a></h4>
            </li>
            <li class="nav-item">
                <h4><a id="contactos1" class="nav-link {{request()->is('contactos')?'active':''}}"
                       href="{{route('contactos')}}">Contactos</a></h4>
            </li>
            <li class="nav-item">
                <a href=""></a>
            </li>
        </ul>
        <h4><a id="registrar1" href="{{route('registro')}}">Registrar</a></h4>&nbsp;&nbsp;&nbsp;
        <!-- Boton Modal -->
